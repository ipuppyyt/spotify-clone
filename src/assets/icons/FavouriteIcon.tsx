...
const FavouriteIcon = (props: FavouriteIconProps) => {
    return (
        <svg width={props.width} height={props.height} viewBox="0 -0.5 21 21" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <g id="Page-1" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                <g id="Dribbble-Light-Preview" transform="translate(-179.000000, -600.000000)" fill={props.color}>
